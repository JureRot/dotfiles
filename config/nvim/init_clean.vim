...
"currently done:
	"basic config
	"vim-plug
		"gruvbox comunity edition
		"lexima.vim (to be removed/replaced)
		"raibow_parentheses
		"vim-slime (repl for sbcl (and other)) to work with tmux
	"custom statusline
	"basic mappings
"THIS IS WORK IN PROGRESS
"THIS IS WORK IN PROGRESS
...
"THIS IS WORK IN PROGRESS
"goal:
	"as little pluggins as possible
	"built in lsp
	"use of lf, fzf, ...
	"custom stripts instead of plugins
	"custom color scheme
	"expand by language (sbcl, c, python, java, r, ...)
...
call plug#begin('~/.nvim/vim-plug')
	...
	"closing brackers (auto-pair or lexima) TO BE REMOVED / REPLACED
